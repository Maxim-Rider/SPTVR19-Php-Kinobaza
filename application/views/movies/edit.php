...
<textarea class="form-control input-lg" name="description" value="<?php echo $descriptions_movies; ?>" placeholder="описание"></textarea><br>
...
<input class="form-control input-lg" type="input" name="category_id" value="<?php echo $category_id_movies; ?>" placeholder="категория (1=фильма; 2=сериал"><br>
<input type="sumbit" class="btn btn-success" name="submit" value="Редактировать фильм/сериал">
