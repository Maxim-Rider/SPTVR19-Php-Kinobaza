<div class="well">
    ...
    <fieldset>
        ...
        <p id="cont">Отправиьте ваш отзыв о портале КиноБаза</p>
        ...
        <div class="form-group">
            <input class="form-control" name="email" placeholder="Ваше email" type="text" value="<?php echo set_value('email'); ?>" />
