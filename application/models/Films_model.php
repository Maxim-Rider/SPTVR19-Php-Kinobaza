...
class Films_model extends CI_model {
    ...
    public function setMovies($slug, $name, $description, $year, $rating, $poster, $player_code, $director, $add_date, $category_id) {
        $data = array(
            'slug' => $slug,
            'name' => $name,
    ...
    public function updateMovies($id, $slug, $name, $description, $year, $rating, $poster, $player_code, $director, $add_date, $category_id) {
        $data = array(
            'id' => $id,
            'slug' => $slug,
            'name' => $name,
    ...
    public function deleteMovies($slug) {
        return $this->db->delete('movie', $data, array('slug'=>$slug));
    }
